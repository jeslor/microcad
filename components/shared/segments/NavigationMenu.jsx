...
const NavigationMenuDemo = () => {
  return (
    <NavigationMenu.Root className=" navContent">
       <Link href='/' className="flex items-center pt-3 pb-2">
          <Image src="/media/microcad_logo.png" alt="Microcad Logo" width={200} height={50} />
        </Link>
      <NavigationMenu.List className="relative center shadow-blackA4 m-0 flex list-none rounded-[6px] p-1 ">
        <NavigationMenu.Item className='mainNavItemHolder'>
          <NavigationMenu.Trigger className="mainNavLinks">
          systems{' '}
            <CaretDownIcon
        ...
        <NavigationMenu.Item className='mainNavItemHolder'>
          ...
          <NavigationMenu.Content className=" bg-slate-100 absolute top-0 left-0 w-full sm:w-auto">
            <ul className="m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[600px] sm:grid-flow-col sm:grid-rows-3">
              <ListItem title="Thin client" href="/primitives/docs/overview/introduction">
                Build high-quality, accessible design systems and web apps.
              </ListItem>
              <ListItem title="Getting started" href="/primitives/docs/overview/getting-started">
                A quick tutorial to get you up and running with Radix Primitives.
        ...
        <NavigationMenu.Item>
          ...
          <NavigationMenu.Content className="absolute top-0 left-0 w-full sm:w-auto bg-slate-100">
            <ul className="m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[600px] sm:grid-flow-col sm:grid-rows-3">
              <ListItem title="Introduction" href="/primitives/docs/overview/introduction">
                Build high-quality, accessible design systems and web apps.
              </ListItem>
        ...
        <a className="pl-3 text-3xl" href=""><Icon icon="mdi:cart-outline"  /></a>

        <div  className="perspective-[2000px] absolute top-full left-0 flex w-full  z-30 shadow-lg">
        ...
        <NavigationMenu.Indicator className="data-[state=visible]:animate-fadeIn data-[state=hidden]:animate-fadeOut top-full z-[1] flex h-[10px] items-end justify-center overflow-hidden transition-[width,transform_250ms_ease]">
          <div className="relative top-[70%] h-[10px] w-[10px] rotate-[45deg] rounded-tl-[2px] bg-slate-300" />
