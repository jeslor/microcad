...
{
    category:'network',
    subCategories:['network interface cards', 'media converters', 'firewalls & security', 'print servers', 'rackmount lcds', 'switchboxes', 'router switches', 'wireless devices', 'modems', 'powerline network adapters', 'video consoles & extenders']
},
{
    category:'storage',
...
{
    category: 'display',
    subCategories:['monitors', 'projectors', 'projector lamps', 'touchscreen', 'digital signage']
},
{
